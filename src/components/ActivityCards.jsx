...
const activities = [
  {
    ...
    ingredients: ['Glue', 'Borax', 'Food coloring', 'Glitter', 'Water'],
    duration: '15-20 min',
  },
  {
    id: 2,
  ...
  },
  {
    id: 4,
    title: 'Pot Painting',
    description: 'Transform terracotta pots into art pieces',
    color: 'hsl(351, 83%, 61%)',
    emoji: '🪴',
    videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    ingredients: ['Terracotta pot', 'Acrylic paints', 'Sealant', 'Brushes'],
    duration: '20-25 min',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    description: 'Design unique bracelets and necklaces',
    color: 'hsl(160, 50%, 75%)',
    emoji: '💎',
    videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    ingredients: ['Beads', 'Elastic string', 'Charms', 'Clasps'],
    duration: '15-20 min',
  },
  {
    id: 7,
    title: 'Sand Art',
    description: 'Layer colorful sand into beautiful bottles',
    color: 'hsl(20, 90%, 75%)',
    emoji: '🏖️',
    videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    ingredients: ['Colored sand', 'Glass bottle', 'Funnel', 'Stick'],
    duration: '10-15 min',
  },
  {
    id: 8,
  ...
  },
  {
    id: 9,
    title: 'Mosaic Art',
    description: 'Create stunning patterns with tile pieces',
    color: 'hsl(351, 83%, 61%)',
    emoji: '🧩',
    videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    ingredients: ['Mosaic tiles', 'Base board', 'Grout', 'Adhesive'],
    duration: '30-40 min',
  },
  {
    id: 10,
    title: 'Puppet Making',
    description: 'Craft adorable sock puppets',
    color: 'hsl(174, 62%, 47%)',
    emoji: '🧦',
    videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    ingredients: ['Socks', 'Googly eyes', 'Felt', 'Yarn', 'Fabric glue'],
    duration: '20-25 min',
  },
];
