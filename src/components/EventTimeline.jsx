...
const milestones = [
  ...
  },
  {
    ...
    number: "02",
    title: "Planning",
    description: "Detailed planning and theme selection for your event",
    icon: Calendar,
  },
  {
    id: 3,
    number: "03",
    title: "Design",
    description: "Creative design concepts and decoration mockups",
    icon: Sparkles,
  },
  {
    id: 4,
    number: "04",
    title: "Budget",
    description: "Transparent pricing and budget allocation discussion",
    icon: Calendar,
  },
  {
    id: 5,
    number: "05",
    title: "Approval",
    description: "Final design approval and confirmation of details",
    icon: Users,
  },
  {
    id: 6,
    number: "06",
    title: "Preparation",
    description: "Material sourcing and decoration preparation phase",
    icon: MapPin,
  },
  {
    id: 7,
    number: "07",
    title: "Setup",
    description: "Professional setup and decoration installation",
    icon: Sparkles,
  },
  {
    id: 8,
    number: "08",
    title: "Final Touch",
    description: "Last-minute adjustments and quality checks",
    icon: Sparkles,
  },
  {
    id: 9,
    number: "09",
    title: "Celebration",
    description: "Your perfect event comes to life beautifully",
    icon: Users,
  },
  {
    id: 10,
    number: "10",
    title: "Follow-up",
    description: "Post-event feedback and photo collection",
    icon: Calendar,
  },
];
      ...
      <RoadWrapper>
        <RoadContainer style={{ x }}>
          ...
          {milestones.map((milestone, index) => {
            const positions = [
              { x: 250, y: 160, rotation: 15, cardOffset: -180 },
              { x: 550, y: 270, rotation: 20, cardOffset: -180 },
              { x: 900, y: 330, rotation: -10, cardOffset: -180 },
              { x: 1250, y: 480, rotation: 25, cardOffset: -180 },
              { x: 1650, y: 570, rotation: 30, cardOffset: -180 },
              { x: 1950, y: 690, rotation: 20, cardOffset: -180 },
              { x: 2350, y: 790, rotation: 25, cardOffset: -180 },
              { x: 2750, y: 890, rotation: 15, cardOffset: -180 },
              { x: 3150, y: 970, rotation: 20, cardOffset: -180 },
              { x: 3550, y: 1060, rotation: 25, cardOffset: -180 },
            ];
